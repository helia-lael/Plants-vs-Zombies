...
//    protected TranslateTransition transition;
    ...
    public Zombie(int health, double speed, double x, double y) {
        this.health = health;
        this.speed = speed;
        this.healthState = ZombieHealthState.HEALTHY;
        this.setLayoutX(x);
        this.setLayoutY(y);
...
//    void TakeDamage (int damage) {};
    public void eating() {
        setActionState(ZombieActionState.EATING);
    }

    public void moving() {
        setActionState(ZombieActionState.MOVING);
    }

    public void stopMoving() {
        setActionState(ZombieActionState.STOPPED);
    }

...
//        borderPane = new BorderPane();
        ...
        for(int row = 0; row < 5; row++) {
            for(int col = 0; col < 9; col++) {
                ...
                Cell cell = new Cell(row,col,x,y);
                cells.add(cell);
...
/// ////////////////////////////////////////////////
        ...
        Thread thread = new Thread(() -> {
         try{
             ...
             Thread.sleep(((zombieWave1.getWaveTime())*1000)+6000);
             zombieWave2.createWave();
             Thread.sleep(zombieWave2.getWaveTime()*1000+15000);
             zombieMiddleWave.createWave();
             Thread.sleep(zombieMiddleWave.getWaveTime()*1000);
             zombieWave3.createWave();
             Thread.sleep(zombieWave3.getWaveTime()*1000);
             zombieWave4.createWave();
             Thread.sleep(zombieWave4.getWaveTime()*1000);
